...
triplets_ask_prompt = """现在我向你提供以下三元组信息，其基本格式为[[三元组1], [三元组2]……],具体的三元组为：{}\n你需要判断以上信息是否足以回答问题1，如果可以，请返回2，并且回答问题1；如果不可以，则返回3"""
triplets_complement_prompt = """现在我向你补充一下三元组信息，基本格式不变，三元组为：{}\n基于我提供的所有信息，是否能够回答问题1,如果可以，请返回2，并直接回答问题1；如果不可以，则返回3"""
